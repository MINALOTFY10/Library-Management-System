    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BorrowsCopies", x => new { x.MemberId, x.BookCopyId });
                    table.ForeignKey(
                        name: "FK_BorrowsCopies_AspNetUsers_MemberId",
                        column: x => x.MemberId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BorrowsCopies_BookCopies_BookCopyId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "7f34e905-33c1-4e2f-bc5c-3d64f6a93d74", null, "Admin", "admin" },
                    { "ef5d0cb5-a0c4-41d1-bb70-1657663feaab", null, "Client", "client" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowsCopies_BookCopyId",
                table: "BorrowsCopies",
                column: "BookCopyId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "7f34e905-33c1-4e2f-bc5c-3d64f6a93d74");

            migrationBuilder.DeleteData(
                table: "AspNetRoles",
                keyColumn: "Id",
                keyValue: "ef5d0cb5-a0c4-41d1-bb70-1657663feaab");
